...
#------------------------------
    ...
    probdata.add_param('r0',  50,  'location of dam')
    probdata.add_param('hin', 100.0, 'h inside dam')
    probdata.add_param('hout', 5.0,  'h outside dam')
    ...
    clawdata.upper[0] = 200          # xupper
    clawdata.lower[1] = -200          # ylower
    clawdata.upper[1] = 200          # yupper
