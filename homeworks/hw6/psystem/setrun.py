...
#------------------------------
    ...
    probdata.add_param('a',     2.0,  'a in isothermal equations')
    probdata.add_param('vleft',  1.,  'vleft')
    probdata.add_param('uleft',  -2.0,  'uleft')
    probdata.add_param('vright',  1.,  'vright')
    probdata.add_param('uright',  2.0,  'uright')
